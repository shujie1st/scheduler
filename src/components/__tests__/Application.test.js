...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 4. Change student name to "Andy Cohen".
    fireEvent.change(getByDisplayValue(appointment, "Archie Cohen"), {
      target: { value: "Andy Cohen" }
    });
    ...
    // 7. Wait until the element with the text "Andy Cohen" is displayed.
    await waitForElement(() => getByText(appointment, "Andy Cohen"));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    // 1. Fake an error with axios to test error handling
    ...
    // 5. Change student name to "Andy Cohen".
    fireEvent.change(getByDisplayValue(appointment, "Archie Cohen"), {
      target: { value: "Andy Cohen" }
    });
    ...
    // 8. Wait until the element with the text "Could not save appoinment." is displayed.
    await waitForElement(() => getByText(appointment, "Could not save appoinment."));

    // 9. Click the "Close" button.
    fireEvent.click(getByAltText(appointment, "Close"));

    // 10. Check that the previous mode with the text "Archie Cohen" is displayed.
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    // 8. Wait until the element with the text "Could not cancel appoinment." is displayed.
    await waitForElement(() => getByText(appointment, "Could not cancel appoinment."));

    // 10. Click the "Close" button.
    fireEvent.click(getByAltText(appointment, "Close"));

    // 11. Check that the previous mode with the text "Archie Cohen" is displayed.
